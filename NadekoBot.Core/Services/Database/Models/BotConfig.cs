...
namespace NadekoBot.Core.Services.Database.Models
{
    public class BotConfig : DbEntity
    {
        ...
        public string CurrencyName { get; set; } = "Flower";
        public string CurrencyPluralName { get; set; } = "Flowers";
        ...
        public string HelpString { get; set; } = @"To add me to your server, ask Tony#1275 for an invite url
